...
r=Path(__file__).resolve().parents[1];o=r/'AIAS_NEXT043_LEDGER_INSTALLER'
if o.exists():shutil.rmtree(o)
o.mkdir();fs=[r/'src/aias_next043_ledger/__init__.py',r/'src/aias_next043_ledger/ledger.py',r/'engineering/aias/next043_ledger/AIAS_NEXT_043_SPEC.json',r/'docs/AIAS_NEXT_043_LEDGER.md']
for s in fs:
