...
TARGET = ROOT / "AIAS_WORKSPACE2_W2_02_ORCHESTRATION_INSTALLER"
...
def main():
    ...
    sources = (
        "src/gui/workspace2",
        "engineering/aias/experience/AIAS_WORKSPACE2_W2_02_SPEC.json",
        "docs/AIAS_WORKSPACE2_W2_02.md",
        "tests/test_aias_workspace2_w2_02.py",
    )
    ...
    manifest = {"pack_id": "AIAS-WORKSPACE-2.0-W2-02", "version": "0.2.0", "status": "IMPLEMENTED_VALIDATED", "next": "W2-03"}
