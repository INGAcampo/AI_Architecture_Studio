...
r=Path(__file__).resolve().parents[1];o=r/'AIAS_NEXT071_REPORT_INSTALLER'
if o.exists():shutil.rmtree(o)
o.mkdir();fs=[r/'src/aias_next071_report/__init__.py',r/'src/aias_next071_report/report.py',r/'engineering/aias/next071_report/AIAS_NEXT_071_SPEC.json',r/'docs/AIAS_NEXT_071_REPORT.md']
for s in fs:
