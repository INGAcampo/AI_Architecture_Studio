...
r=Path(__file__).resolve().parents[1];o=r/'AIAS_NEXT064_REPORT_INSTALLER'
if o.exists():shutil.rmtree(o)
o.mkdir();fs=[r/'src/aias_next064_report/__init__.py',r/'src/aias_next064_report/report.py',r/'engineering/aias/next064_report/AIAS_NEXT_064_SPEC.json',r/'docs/AIAS_NEXT_064_REPORT.md']
for s in fs:
