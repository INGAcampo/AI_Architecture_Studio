...
class ProjectFactoryKernel:
    ...
    def enqueue(self, manifest):
        ...
        self._write(project/'PROJECT_MANIFEST.json',manifest); self._write(project/'PROJECT_DEPENDENCY_GRAPH.json',{'project_id':manifest['project_id'],'nodes':['intake','graph','architecture','native_bim','analysis','drawings','quantities','reports','qa','manifest'],'edges':[{'from':'intake','to':'graph'},{'from':'graph','to':'architecture'},{'from':'architecture','to':'native_bim'},{'from':'architecture','to':'analysis'},{'from':'native_bim','to':'drawings'},{'from':'analysis','to':'drawings'},{'from':'architecture','to':'quantities'},{'from':'drawings','to':'reports'},{'from':'quantities','to':'reports'},{'from':'reports','to':'qa'}]})
